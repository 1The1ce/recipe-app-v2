...
import 'package:recipe_app/onboarding/presentation/widgets/last_page_item.dart';

class OnboardingLastPage extends StatelessWidget {
  const OnboardingLastPage({super.key, required this.viewModel});
